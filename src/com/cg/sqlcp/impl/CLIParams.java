...
public interface CLIParams {
	...
	public static final String[] HELPORDER_DB2DB = {
			SRC_JDBC, SRC_USER, SRC_PASSWORD, SRC_DATA, SRC_BUFFERED_ROWS,
			"",
			DEST_DB_JDBC, DEST_DB_USER, DEST_DB_PASSWORD, DEST_DB_TARGET, DEST_DB_BINDTYPES, DEST_DB_SQL_BEF_IMPORT, DEST_DB_NUM_THREADS,
			"",
			BATCHSIZE, PRINTPARAMSONLY, PRINTRUNTIMEINFO, PRINTSUMMARY, GCINTERVALSEC
	};
	
	public static final String[] HELPORDER_DB2FILE = {
			SRC_JDBC, SRC_USER, SRC_PASSWORD, SRC_DATA, SRC_BUFFERED_ROWS,
			"",
			...
			DEST_FILE_FMT_DATE, DEST_FILE_FMT_TIME, DEST_FILE_FMT_DATETIME, DEST_FILE_FMT_TIMESTAMP, DEST_FILE_FMT_TIMESTAMPTZ, 
